...
import com.practice.reverselevel.spring.web.dto.PostsListResponseDto;
...
public class PostsService {
    ...
    public void delete(Long id){
        Posts posts = postsRepository.findById(id).orElseThrow(()->new IllegalArgumentException("해당 게시물이 없음. id="+id));
